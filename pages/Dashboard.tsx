                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="py-5 px-6 align-top">
                                        <div className={`font-bold text-base md:text-lg transition-colors whitespace-normal break-all block h-auto leading-relaxed ${hasStoryboard ? 'text-slate-800 group-hover:text-fuchsia-700' : 'text-slate-500'}`}>
                                            {project.title || '未命名项目'}
                                        </div>
                                    </td>
